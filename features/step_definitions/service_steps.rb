...
Given("I have multiple services listed under me") do
    ...
    @service1 = Service.create(user_id: @user.user_id, name: "Service 1", description: "Description 1", price: 10, duration: 60, is_published: true)
    @service2 = Service.create(user_id: @user.user_id, name: "Service 2", description: "Description 2", price: 15, duration: 90, is_published: true)
