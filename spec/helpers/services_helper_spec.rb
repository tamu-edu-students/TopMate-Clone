    ...
    describe '#user_availability_for_day' do
        context 'when a user exists and has availability' do
            ...
            it 'returns users availability for a given day' do
                hour # loads the hour
                expect(user_availability_for_day(user, Date.parse("01-01-2023")).first['start_time']).to eq(hour.start_time.strftime('%T'))        
            end
        end
    ...
    describe '#remove_appts_from_hours' do
        context 'a user exists, has availability' do
            ...
            it 'splits availability when appointment is in the middle' do
                ...
                expect(remove_appts_from_hours([hour], [appt])).to eq([{ 'start_time' => '09:00:00', 'end_time' => '10:00:00' }, { 'start_time' => '11:00:00', 'end_time' => '17:00:00' }])
            end
            ...
            it 'removes availability when appointment is at the beginning' do
                ...
                expect(remove_appts_from_hours([hour], [appt])).to eq([{ 'start_time' => '11:00:00', 'end_time' => '17:00:00' }])
            end
            ...
            it 'availability does not change when appointment does not overlap' do
                ...
                expect(remove_appts_from_hours([hour], [appt])).to eq([{ 'start_time' => '09:00:00', 'end_time' => '17:00:00' }])
            end
            ...
            it 'removes availability when appointment overlaps hours' do
                ...
                expect(remove_appts_from_hours([hour], [appt])).to eq([{ 'start_time' => '09:00:00', 'end_time' => '15:00:00' }])
            end
        end
    end
end
