...
Rails.application.configure do
  ...
  # Change the email address to send emails from in production
  ...
  config.action_mailer.default_url_options = { host: 'https://topmate-clone-779709a9559a.herokuapp.com/' }
